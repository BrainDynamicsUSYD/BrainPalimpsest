function T = calcTransFuncs_toY_1D(kx, w, params)
%% calcTransFuncs_toY_1D.m
%
% Calculates the 1D transfer functions T.T_YA from A to BOLD signal Y, where 
...
%
% Output: T      : structure containing the transfer functions T_YA.
...
% >> T.T_Yz  % gives out the T_Yz transfer function
%
