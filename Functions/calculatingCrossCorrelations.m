...
for scanNo = 1:11
    filename1 = ['Data/ExpandingRingAndExpandingWedge/GriddedMatFiles/', ...
                  hemisphere, '.Scan', num2str(scanNo), '_resolution=', ...
                  num2str(resolution), '.mat'];
    filename2 = ['Data/ExpandingRingAndExpandingWedge/VisualStimulus/', ...
...
%%             
filename3 = ['Data/ExpandingRingAndExpandingWedge/CorrelationMatFiles/',...
